...
- **code** sería el id del ticket en el sistema propio de la empresa
- **location_id** sería el id ( en el sistema de Loyal Guru ) del establecimiento del tpv de la empresa ( otorgado por Loyal Guru )
- **location_code** sería el id ( en el sistema de la empresa, pero asignado internamente a loyal guru ) del establecimiento del tpv de la empresa.
